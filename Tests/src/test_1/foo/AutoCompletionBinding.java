...
public abstract class AutoCompletionBinding<T> implements EventTarget {
    ...
    private final void onUserInputChanged(final String userText){
        ...
        synchronized (suggestionsTaskLock) {
            ...
            suggestionsTask = new AutoCompletionBinding.FetchSuggestionsTask(userText);
    ...
    public static class AutoCompletionEvent<TE> extends Event {
        ...
        public static final EventType<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent> AUTO_COMPLETED =
                new EventType<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent>("AUTO_COMPLETED");
    ...
    private ObjectProperty<EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent<T>>> onAutoCompleted;

    /**
     * Set a event handler which is invoked after an auto completion.
     * @param value
     */
    public final void setOnAutoCompleted(EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent<T>> value) {
        onAutoCompletedProperty().set( value);
    }

    public final EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent<T>> getOnAutoCompleted() {
        return onAutoCompleted == null ? null : onAutoCompleted.get();
    }

    public final ObjectProperty<EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent<T>>> onAutoCompletedProperty() {
        if (onAutoCompleted == null) {
            onAutoCompleted = new ObjectPropertyBase<EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent<T>>>() {
                @SuppressWarnings({ "rawtypes", "unchecked" })
                @Override protected void invalidated() {
                    eventHandlerManager.setEventHandler(
                            org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent.AUTO_COMPLETED,
                            (EventHandler<org.controlsfx.control.textfield.AutoCompletionBinding.AutoCompletionEvent>)(Object)get());
                }
